        ...
        <div className="mb-6 relative">
          ...
          <div className="absolute inset-0 flex">
            <div
              ...
              style={{ cursor: chapter === 0 && page === 1 ? 'not-allowed' : 'pointer' }}
            ></div>
            <div
              className="w-1/2 cursor-pointer"
              onClick={goToNextPage}
              style={{ cursor: chapter === Object.keys(chapterContent).length - 1 && page === currentChapter.pageCount ? 'not-allowed' : 'pointer' }}
            ></div>
          </div>
        </div>
